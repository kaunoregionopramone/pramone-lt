...
export default defineType({
  ...
  fields: [
    ...
    {
      name: "metuPatirtisAprasymas",
      title: "Metų patirtis aprašymas",
      type: "text",
      rows: 3,
      description: "Aprašymas šalia metų patirties skaičiaus pagrindiniame puslapyje",
    },
    {
      name: "asociacijosNariaiAprasymas",
      title: "Asociacijos nariai aprašymas",
      type: "text",
      rows: 3,
      description: "Aprašymas šalia narių skaičiaus pagrindiniame puslapyje",
    },
    {
